package cn.structure.starter.manager.mapper.provider;
 ...
 *
 */
public class InsertListSpecialProvider extends MapperTemplate {

    public InsertListSpecialProvider(Class<?> mapperClass, MapperHelper mapperHelper) {
